...
INTCONVAL 	equ 0xa0	;interrupt control
;	1 0 1 0 0 0 0 0
;	| | | | | | | |_RBIF
;	| | | | | | |___INTF
;	| | | | | |_____T0IF
...
T0INT:
	...
	btfsc PORTA,PWMOUTBIT 		; which edge is required?
...
HighImpShrt:
	...
	bsf PORTA,PWMOUTBIT 	; rising edge, 28 cycles hi pulse
	bsf PORTA,PWMOUTBIT 	; 27 cycles
	bsf PORTA,PWMOUTBIT 	; 26 cycles
	bsf PORTA,PWMOUTBIT 	; 25 cycles
	bsf PORTA,PWMOUTBIT 	; 24 cycles
	bsf PORTA,PWMOUTBIT 	; 23 cycles
	bsf PORTA,PWMOUTBIT 	; 22 cycles
	bsf PORTA,PWMOUTBIT 	; 21 cycles
	bsf PORTA,PWMOUTBIT 	; 20 cycles
	bsf PORTA,PWMOUTBIT 	; 19 cycles
	bsf PORTA,PWMOUTBIT 	; 18 cycles
	bsf PORTA,PWMOUTBIT 	; 17 cycles
	bsf PORTA,PWMOUTBIT 	; 16 cycles
	bsf PORTA,PWMOUTBIT 	; 15 cycles
	bsf PORTA,PWMOUTBIT 	; 14 cycles
	bsf PORTA,PWMOUTBIT 	; 13 cycles
	bsf PORTA,PWMOUTBIT 	; 12 cycles
	bsf PORTA,PWMOUTBIT 	; 11 cycles
	bsf PORTA,PWMOUTBIT 	; 10 cycles
	bsf PORTA,PWMOUTBIT 	; 9 cycles
	bsf PORTA,PWMOUTBIT 	; 8 cycles
	bsf PORTA,PWMOUTBIT 	; 7 cycles
	bsf PORTA,PWMOUTBIT 	; 6 cycles
	bsf PORTA,PWMOUTBIT 	; 5 cycles
	bsf PORTA,PWMOUTBIT 	; 4 cycles
	bsf PORTA,PWMOUTBIT 	; 3 cycles
	bsf PORTA,PWMOUTBIT 	; 2 cyclesbsf PORTA,PWMOUTBIT ; 1 cycle
	bsf PORTA,PWMOUTBIT 	; 1 cyclesbsf PORTA,PWMOUTBIT ; 1 cycle
	bcf PORTA,PWMOUTBIT 	; fall edge;start of the following
...
HighImpInt: 				; high pulse using interrupt
	...
	movwf TMR0 			; put value into timer
HighImpInt2:
	bsf PORTA,PWMOUTBIT 		; generate rising edge
...
LowImpShrt:
	movf PWMMAX,W 			; get number of inst’s to skip
	addwf PCL,F 			; skip n instructions
	bcf PORTA,PWMOUTBIT 		; falling edge, 27 cycles low pulse
	bcf PORTA,PWMOUTBIT 		; 26 cycles
	bcf PORTA,PWMOUTBIT 		; 25 cycles
	bcf PORTA,PWMOUTBIT 		; 24 cycles
	bcf PORTA,PWMOUTBIT 		; 23 cycles
	bcf PORTA,PWMOUTBIT 		; 22 cycles
	bcf PORTA,PWMOUTBIT 		; 21 cycles
	bcf PORTA,PWMOUTBIT 		; 20 cycles
	bcf PORTA,PWMOUTBIT 		; 19 cycles
	bcf PORTA,PWMOUTBIT 		; 18 cycles
	bcf PORTA,PWMOUTBIT 		; 17 cycles
	bcf PORTA,PWMOUTBIT 		; 16 cycles
	bcf PORTA,PWMOUTBIT 		; 15 cycles
	bcf PORTA,PWMOUTBIT 		; 14 cycles
	bcf PORTA,PWMOUTBIT 		; 13 cycles
	bcf PORTA,PWMOUTBIT 		; 12 cycles
	bcf PORTA,PWMOUTBIT 		; 11 cycles
	bcf PORTA,PWMOUTBIT 		; 10 cycles
	bcf PORTA,PWMOUTBIT 		; 9 cycles
	bcf PORTA,PWMOUTBIT 		; 8 cycles
	bcf PORTA,PWMOUTBIT 		; 7 cycles
	bcf PORTA,PWMOUTBIT 		; 6 cycles
	bcf PORTA,PWMOUTBIT 		; 5 cycles
	bcf PORTA,PWMOUTBIT 		; 4 cycles
	bcf PORTA,PWMOUTBIT 		; 3 cycles
	bcf PORTA,PWMOUTBIT 		; 2 cycles
	bcf PORTA,PWMOUTBIT 		; 1 cycle
	bsf PORTA,PWMOUTBIT 		; rising edge; start of the next
...
LowImpInt: 				; low pulse using interrupt
	...
	movwf TMR0 			; put value into timer
LowImpInt2:
	bcf PORTA,PWMOUTBIT 		; generate falling edge
	movlw PWMMAXVAL
	movwf PWMMAX
	bsf flag,falege
